#!/bin/bash
# Submit four report baseline jobs with one million events per model.
...
CAMPAIGN="${CAMPAIGN:-report_baselines_1m_b32_$(date +%Y%m%d_%H%M%S)}"
...
submit_run ml_t2_1m_b32 ECalTpadTransformer 2e 2 128 3 4 256 4 128 16 \
  transformer_2e_1m_h128_l3_b32_seed7
submit_run ml_t3_1m_b32 ECalTpadTransformer 3e 3 128 3 4 256 4 128 16 \
  transformer_3e_1m_h128_l3_b32_seed7
submit_run ml_g2_1m_b32 ECalTpadGravNet 2e 2 128 4 4 256 4 128 16 \
  gravnet_2e_1m_h128_l4_k16_bn_b32_seed7
submit_run ml_g3_1m_b32 ECalTpadGravNet 3e 3 128 4 4 256 4 128 16 \
  gravnet_3e_1m_h128_l4_k16_bn_b32_seed7
